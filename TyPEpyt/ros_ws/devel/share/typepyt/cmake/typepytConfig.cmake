...
if("TRUE" STREQUAL "TRUE")
  set(typepyt_SOURCE_PREFIX /home/e/ROS/ROS-demo/TyPEpyt/ros_ws/src/typepyt)
  set(typepyt_DEVEL_PREFIX /home/e/ROS/ROS-demo/TyPEpyt/ros_ws/devel)
  set(typepyt_INSTALL_PREFIX "")
  set(typepyt_PREFIX ${typepyt_DEVEL_PREFIX})
else()
  set(typepyt_SOURCE_PREFIX "")
  set(typepyt_DEVEL_PREFIX "")
  set(typepyt_INSTALL_PREFIX /home/e/ROS/ROS-demo/TyPEpyt/ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Elecia White <elecia@mailinator.com>, Elecia White <elecia@mailinator.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'typepyt' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'typepyt' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/e/ROS/ROS-demo/TyPEpyt/ros_ws/src/typepyt/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT typepyt_NUM_DUMMY_TARGETS)
      set(typepyt_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::typepyt::wrapped-linker-option${typepyt_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR typepyt_NUM_DUMMY_TARGETS "${typepyt_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::typepyt::wrapped-linker-option${typepyt_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND typepyt_LIBRARIES "${interface_target_name}")
...
set(typepyt_EXPORTED_TARGETS "typepyt_generate_messages_cpp;typepyt_generate_messages_eus;typepyt_generate_messages_lisp;typepyt_generate_messages_nodejs;typepyt_generate_messages_py")
...
set(depends "actionlib_msgs;sensor_msgs;geometry_msgs")
...
set(pkg_cfg_extras "typepyt-msg-extras.cmake")
