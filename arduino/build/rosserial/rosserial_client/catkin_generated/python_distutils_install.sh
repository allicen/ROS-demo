...
echo_and_run cd "/home/e/ROS-demo/arduino/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/e/ROS-demo/arduino/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/e/ROS-demo/arduino/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
