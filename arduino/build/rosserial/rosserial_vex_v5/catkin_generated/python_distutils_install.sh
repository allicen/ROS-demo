...
echo_and_run cd "/home/e/ROS-demo/arduino/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/e/ROS-demo/arduino/src/rosserial/rosserial_vex_v5/setup.py" \
     \
    build --build-base "/home/e/ROS-demo/arduino/build/rosserial/rosserial_vex_v5" \
    install \
    --root="${DESTDIR-/}" \
