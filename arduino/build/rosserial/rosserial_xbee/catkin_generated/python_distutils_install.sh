...
echo_and_run cd "/home/e/ROS-demo/arduino/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/e/ROS-demo/arduino/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/e/ROS-demo/arduino/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
